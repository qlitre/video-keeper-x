          ...
          {videoList.length === 0 ? (
            <div class='bg-white shadow rounded-lg p-8'>
              <div class='text-center'>
                ...
                <p class='mt-1 text-sm text-gray-500'>最初の動画を追加してみましょう</p>
                <a
                  href='/videos/add'
                      ...
                      <tr key={video.id} class='hover:bg-gray-50'>
                        <td class='px-6 py-4 whitespace-nowrap'>
                          <div>
                            ...
                            {video.song_name && (
                              <div class='text-sm text-gray-500'>{video.song_name}</div>
                            )}
                          </div>
                        </td>
                        <td class='px-6 py-4'>
                        ...
                        <td class='px-6 py-4 whitespace-nowrap'>
                          <div class='text-sm text-gray-900'>@{video.x_account_id}</div>
                        </td>
